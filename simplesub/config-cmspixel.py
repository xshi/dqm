...
def fullconverter(params):
    ...
    params["NUMBER_OF_EVENTS"] = "1000000000"   #this is the max to avoid crash!             # How many events shall be processed?
    ...
    params["EventSelection"] = "1" # "2"			    # Select the events to process: 0 - all, 1 - only with correct No. of ROC headers, 2 - only with corr. ROC headers and without bit errors in them.-->
